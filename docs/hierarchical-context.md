...
coding agentの階層instruction機能は有力な実装例ですが、料金体系や利用条件が製品ごとに異なります。この文書から具体的な外部製品リンクを掲載する場合は [`external-tool-reference-policy.md`](external-tool-reference-policy.md) の条件を満たすものだけに限定します。
