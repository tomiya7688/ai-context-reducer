...
導入判断の詳細は [`adoption-priority.md`](導入優先度.md) を参照します。
...
ただし全部入りにはしないでください。
まず ai-context-reducer の README、docs/jp/導入優先度.md、templates/AI_CONTEXT.md だけを入口として読み、対象プロジェクトは shallow inspection から始めてください。
